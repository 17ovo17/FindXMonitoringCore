...
export const PLATFORM_BLOCKERS = {
  ...
  site: 'BLOCKED_BY_CONTRACT: 站点配置读取/保存、权限点、审计和回滚契约尚未开放。',
  variables: 'BLOCKED_BY_CONTRACT: 变量配置 CRUD、加密字段和引用影响分析契约尚未开放。',
  sso: 'BLOCKED_BY_CONTRACT: SSO 配置读取/保存、回调校验、启停和测试登录契约尚未开放。',
  engines: 'BLOCKED_BY_CONTRACT: 告警引擎列表、心跳、启停和删除契约尚未开放。',
  healthAction: 'BLOCKED_BY_CONTRACT: 平台健康修复动作缺少执行、审计和回滚契约。',
}
