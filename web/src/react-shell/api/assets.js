...
export const ASSET_BLOCKERS = {
  hostCreate: '主机新建、编辑、删除、云导入和 Excel 导入缺少 FindX 审计契约。',
  terminal: '远程终端、文件上传和命令执行缺少会话、审计和回滚契约。',
  monitor: '主机监控弹窗缺少进程、端口和全量指标 Adapter 契约。',
  agentLifecycle: 'FindX Agent 部署、卸载、重启、删除和进度记录缺少生命周期契约。',
  agentPackage: 'Agent 能力包、配置下发和数据到达验证缺少生命周期契约。',
}
