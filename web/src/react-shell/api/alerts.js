...
export const alertsApi = {
  ...
  listNotificationChannels: async () => normalizeAlertList(await get('/notifications/channels'), 'channels'),
  listNotificationTemplates: async () => normalizeAlertList(await get('/notifications/templates'), 'templates'),
  listBusinessGroups: async () => normalizeAlertList(await get('/workspaces'), 'groups'),
