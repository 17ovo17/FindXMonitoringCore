...
export const ORG_BLOCKERS = {
  create: '缺少该 section 的创建、输入校验、权限点和审计契约，已禁止保存。',
  edit: '缺少该 section 的单条详情或更新契约，已禁止保存。',
  delete: '缺少该 section 的删除、幂等和审计契约，已禁止删除。',
  members: '缺少成员增删、批量选择和回滚契约，已禁止成员变更。',
  status: '缺少启停状态、权限点和审计契约，已禁止状态变更。',
  roleOps: '缺少角色操作点保存契约时仅展示权限矩阵，不执行保存。',
}
