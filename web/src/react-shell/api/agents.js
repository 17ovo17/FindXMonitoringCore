...
export const AGENT_BLOCKERS = {
  packageLifecycle: '能力包下载、内置包仓库、签名校验、发布、停用和删除缺少 Agent Adapter 契约。',
  installLifecycle: '本机安装、远程安装、Kubernetes 安装、执行回执和审计记录缺少 Agent Adapter 契约。',
  configLifecycle: '配置模板保存、远程 writer、reload 回执、drift 检测、灰度/全量下发、回滚、审计记录和 Evidence Chain 缺少 Agent Adapter 契约。',
  heartbeat: '心跳详情、丢包检测、版本漂移、进程状态和服务注册缺少 Agent Adapter 契约。',
  dataArrival: '心跳、指标、日志、链路、性能分析、巡检、拓扑、前端体验和网关链路数据到达验证缺少 Agent Adapter 契约。',
  traceLinkage: '服务目录覆盖率、链路详情反查 Agent 状态、拓扑节点安装证据缺少 APM 与 Agent 联动契约。',
}
