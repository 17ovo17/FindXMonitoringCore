...
export const DATA_ARRIVAL_SIGNALS = [
  {
    ...
    blocker: 'PENDING: heartbeat receiver evidence 缺失，且不能替代其他数据到达信号。',
  },
  {
    kind: 'metrics',
    label: 'metrics / 指标',
    acceptance: '主机、容器、进程和运行时指标 receiver evidence',
    blocker: 'PENDING: metrics 数据到达缺少 receiver evidence，heartbeat 不能替代 metrics。',
  },
  {
    kind: 'logs',
    label: 'logs / 日志',
    acceptance: '日志 receiver evidence，至少一条有效日志记录',
    blocker: 'PENDING: logs receiver evidence 缺失，未证明日志数据到达。',
  },
  {
    kind: 'tracing',
    label: 'tracing / 链路',
    acceptance: '链路 receiver evidence，至少一个 trace/span',
    blocker: 'PENDING: tracing receiver evidence 缺失，未证明 span/trace 数据到达。',
  },
  {
    kind: 'profiling',
    label: 'profiling / 性能分析',
    acceptance: '剖析任务、segment 和结果回执',
    blocker: 'PENDING: profiling 任务、segment 和结果回执契约未开放。',
  },
  {
    kind: 'inspection',
    label: 'inspection / 巡检',
    acceptance: '巡检执行回执、报告和 Evidence Chain',
    blocker: 'PENDING: inspection 执行回执、报告和 Evidence Chain 契约未开放。',
  },
  {
    kind: 'rum',
    label: 'RUM / 前端体验',
    acceptance: 'RUM 事件接收、会话关联和回执',
    blocker: 'PENDING: RUM 事件接收、会话关联和回执契约未开放。',
  },
  {
    kind: 'gateway_trace',
    label: 'gateway trace / 网关链路',
    acceptance: '网关入口/出口 trace 接收、关联和回执',
    blocker: 'PENDING: gateway trace 接收、入口出口关联和回执契约未开放。',
  },
]
