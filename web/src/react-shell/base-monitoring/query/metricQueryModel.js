...
export const blockedContracts = {
  datasource: '指标数据源契约未暴露，当前不能伪造查询上下文。',
  builtInMetrics: '内置指标需要指标分类、搜索、单位、输入联动和权限契约。',
  saveView: '保存视图需要新增、更新、权限和审计契约。',
  shareChart: '分享需要临时图表载荷、访问控制和过期策略契约。',
  graphSettings: '图表设置需要面板持久化契约。',
  aiQuery: 'AI 查询生成需要模型配置、权限和审计契约。',
  recordingRules: '记录规则需要列表、编辑、启停、克隆、删除和权限契约。',
  objectViews: '对象快捷视图需要对象范围和权限契约。',
}
