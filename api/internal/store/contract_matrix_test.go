...
var monitoringContractSeedIDs = []string{
	...
	"FX-CONTRACT-N9E-NOTIFY-RULES-LIST",
	"FX-CONTRACT-N9E-NOTIFY-RULE-DETAIL",
	"FX-CONTRACT-N9E-NOTIFY-RULES-CREATE",
	"FX-CONTRACT-N9E-NOTIFY-RULE-UPDATE",
	"FX-CONTRACT-N9E-NOTIFY-RULES-DELETE",
	"FX-CONTRACT-N9E-NOTIFY-RULE-CUSTOM-PARAMS",
	"FX-CONTRACT-N9E-NOTIFY-RULE-TEST",
	"FX-CONTRACT-N9E-NOTIFY-STATISTICS",
	"FX-CONTRACT-N9E-NOTIFY-EVENTS",
	"FX-CONTRACT-N9E-NOTIFY-ALERT-RULES",
	"FX-CONTRACT-N9E-NOTIFY-SUBSCRIBE-RULES",
	"FX-CONTRACT-N9E-NOTIFY-EVENT-TAGKEYS",
	"FX-CONTRACT-N9E-NOTIFY-FEISHU-GROUPS",
	"FX-CONTRACT-N9E-NOTIFY-FLASHDUTY-CHANNELS",
	"FX-CONTRACT-N9E-NOTIFY-PAGERDUTY-SERVICES",
	"FX-CONTRACT-N9E-NOTIFY-PAGERDUTY-CONNECTOR-LOOKUP",
	"FX-CONTRACT-N9E-NOTIFY-CHANNEL-CONFIGS-LIST",
	"FX-CONTRACT-N9E-NOTIFY-CHANNEL-CONFIGS-SIMPLIFIED",
	"FX-CONTRACT-N9E-NOTIFY-CHANNEL-CONFIGS-CREATE",
	"FX-CONTRACT-N9E-NOTIFY-CHANNEL-CONFIG-UPDATE",
	"FX-CONTRACT-N9E-NOTIFY-CHANNEL-CONFIG-DETAIL",
	"FX-CONTRACT-N9E-NOTIFY-CHANNEL-CONFIG-BY-IDENT",
	"FX-CONTRACT-N9E-NOTIFY-CHANNEL-CONFIGS-DELETE",
	"FX-CONTRACT-N9E-NOTIFY-CHANNEL-CONFIG-IDENTS",
	"FX-CONTRACT-N9E-MESSAGE-TEMPLATES-LIST",
	"FX-CONTRACT-N9E-MESSAGE-TEMPLATE-DETAIL",
	"FX-CONTRACT-N9E-MESSAGE-TEMPLATES-CREATE",
	"FX-CONTRACT-N9E-MESSAGE-TEMPLATE-UPDATE",
	"FX-CONTRACT-N9E-MESSAGE-TEMPLATES-DELETE",
	"FX-CONTRACT-N9E-MESSAGE-TEMPLATE-PREVIEW",
	"FX-CONTRACT-N9E-NOTIFY-CONTACTS-LIST",
	"FX-CONTRACT-N9E-NOTIFY-CONTACTS-UPDATE",
	"FX-CONTRACT-N9E-MANAGE-NOTIFY-CHANNELS",
	"FX-CONTRACT-N9E-MANAGE-CONTACT-CHANNELS",
	"FX-CONTRACT-N9E-MANAGE-CONTACT-KEYS",
	...
	"FX-CONTRACT-N9E-ALERT-EVENT-SHARED-DETAIL",
	"FX-CONTRACT-N9E-EVENT-PIPELINE-CRUD",
	"FX-CONTRACT-N9E-EVENT-PIPELINE-LIST",
	"FX-CONTRACT-N9E-EVENT-PIPELINE-DETAIL",
	"FX-CONTRACT-N9E-EVENT-PIPELINE-CREATE",
	"FX-CONTRACT-N9E-EVENT-PIPELINE-UPDATE",
	"FX-CONTRACT-N9E-EVENT-PIPELINE-DELETE",
	...
	"FX-CONTRACT-N9E-EVENT-PIPELINE-EXECUTIONS-LIST",
	"FX-CONTRACT-N9E-EVENT-PIPELINE-EXECUTION-DETAIL",
	"FX-CONTRACT-N9E-ALERT-EVENT-RULE-TESTER",
