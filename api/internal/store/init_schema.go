...
var createTableStatements = []string{
	...
	`CREATE TABLE IF NOT EXISTS ai_memories (id VARCHAR(64) PRIMARY KEY,type VARCHAR(32) NOT NULL,content TEXT NOT NULL,tags JSON,score DOUBLE DEFAULT 1.0,used_count INT DEFAULT 0,session_id VARCHAR(64),created_at DATETIME NOT NULL,expires_at DATETIME NULL,INDEX idx_aim_type(type),INDEX idx_aim_session(session_id),INDEX idx_aim_created(created_at),FULLTEXT INDEX idx_aim_content(content)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4`,
}
